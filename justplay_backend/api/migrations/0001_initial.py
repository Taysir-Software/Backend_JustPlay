    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('stripe', 'Stripe'), ('paypal', 'PayPal'), ('cash', 'Cash')], max_length=20)),
                ('status', models.CharField(choices=[('paid', 'Payé'), ('failed', 'Échoué'), ('refunded', 'Remboursé')], default='paid', max_length=10)),
